...
/**
 * Gap/CFS Feature Page: No equipment rental marketplace or availability tracker.
 * Slug: no-equipment-rental-marketplace-or-availability-tracker
 * Backend: /api/gap-no-equipment-rental-marketplace-or-availability-tracker
 */
export default function NoEquipmentRentalMarketplaceOrAvailabilityTrackerPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-equipment-rental-marketplace-or-availability-tracker', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No equipment rental marketplace or availability tracker.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No equipment rental marketplace or availability tracker.</p>
