...
/**
 * Gap/CFS Feature Page: Vision-based site inspection
 * Slug: vision-based-site-inspection
 * Backend: /api/cf-vision-based-site-inspection
 */
export default function VisionBasedSiteInspectionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-vision-based-site-inspection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Vision-based site inspection</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Upload construction site photos; AI detects delays, safety violations, quality issues.</p>
