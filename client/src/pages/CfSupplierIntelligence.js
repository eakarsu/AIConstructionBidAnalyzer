...
/**
 * Gap/CFS Feature Page: Supplier intelligence
 * Slug: supplier-intelligence
 * Backend: /api/cf-supplier-intelligence
 */
export default function SupplierIntelligencePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-supplier-intelligence', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Supplier intelligence</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Scrape vendor catalogs, pricing, lead times; recommend optimal sourcing.</p>
