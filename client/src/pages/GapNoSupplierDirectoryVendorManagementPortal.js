...
/**
 * Gap/CFS Feature Page: No supplier directory / vendor-management portal.
 * Slug: no-supplier-directory-vendor-management-portal
 * Backend: /api/gap-no-supplier-directory-vendor-management-portal
 */
export default function NoSupplierDirectoryVendorManagementPortalPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-supplier-directory-vendor-management-portal', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No supplier directory / vendor-management portal.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No supplier directory / vendor-management portal.</p>
