...
/**
 * Gap/CFS Feature Page: Limited mobile/field app surfaces.
 * Slug: limited-mobile-field-app-surfaces
 * Backend: /api/gap-limited-mobile-field-app-surfaces
 */
export default function LimitedMobileFieldAppSurfacesPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-mobile-field-app-surfaces', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited mobile/field app surfaces.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited mobile/field app surfaces.</p>
