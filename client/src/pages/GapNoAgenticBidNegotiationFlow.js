...
/**
 * Gap/CFS Feature Page: No agentic bid-negotiation flow.
 * Slug: no-agentic-bid-negotiation-flow
 * Backend: /api/gap-no-agentic-bid-negotiation-flow
 */
export default function NoAgenticBidNegotiationFlowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-agentic-bid-negotiation-flow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No agentic bid-negotiation flow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No agentic bid-negotiation flow.</p>
