...
/**
 * Gap/CFS Feature Page: No RFQ automation or vendor outreach workflow.
 * Slug: no-rfq-automation-or-vendor-outreach-workflow
 * Backend: /api/gap-no-rfq-automation-or-vendor-outreach-workflow
 */
export default function NoRfqAutomationOrVendorOutreachWorkflowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-rfq-automation-or-vendor-outreach-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No RFQ automation or vendor outreach workflow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No RFQ automation or vendor outreach workflow.</p>
