...
/**
 * Gap/CFS Feature Page: Liability insurance recommendation engine
 * Slug: liability-insurance-recommendation-engine
 * Backend: /api/cf-liability-insurance-recommendation-engine
 */
export default function LiabilityInsuranceRecommendationEnginePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-liability-insurance-recommendation-engine', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Liability insurance recommendation engine</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Suggest coverage limits and policy types based on project risk profile.</p>
