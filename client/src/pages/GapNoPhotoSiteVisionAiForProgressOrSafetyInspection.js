...
/**
 * Gap/CFS Feature Page: No photo / site-vision AI for progress or safety inspection.
 * Slug: no-photo-site-vision-ai-for-progress-or-safety-inspection
 * Backend: /api/gap-no-photo-site-vision-ai-for-progress-or-safety-inspection
 */
export default function NoPhotoSiteVisionAiForProgressOrSafetyInspectionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-photo-site-vision-ai-for-progress-or-safety-inspection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No photo / site-vision AI for progress or safety inspection.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No photo / site-vision AI for progress or safety inspection.</p>
