...
/**
 * Gap/CFS Feature Page: Subcontractor performance scoring
 * Slug: subcontractor-performance-scoring
 * Backend: /api/cf-subcontractor-performance-scoring
 */
export default function SubcontractorPerformanceScoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-subcontractor-performance-scoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Subcontractor performance scoring</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Track quality, timeliness, cost; predict future performance.</p>
